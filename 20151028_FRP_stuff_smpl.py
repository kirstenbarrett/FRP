...
b21meanFilts = {}
meanFiltBand = np.array([[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1],[2,1,2,4,5,6,1,6,7,8,1,3,5,6,2,5,1,6,1,2,1]])
 #INITIALIZE WITH UNFILTERED BAND
kSize = minKsize
...
b21allFilts = b21meanFilts['b21meanFilt'+str(minKsize)]
kSize = minKsize + 2

while kSize <= maxKsize:
    b21allFilts[np.where(b21allFilts == -1)] = b21meanFilts['b21meanFilt'+str(kSize)][np.where(b21allFilts == -1)]
    kSize += 2
