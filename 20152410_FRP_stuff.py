...
kSize = 5
b21bgMask5x5 = ndimage.generic_filter(b21bgMask, meanFilt, kSize)
...
kSize = 21
b21bgMask21x21 = ndimage.generic_filter(b21bgMask13x13, meanFilt, kSize)

b21bgMaskFilts = b21bgMask5x5

b21bgMaskFilts[np.where(b21bgMaskFilts == -1)] = b21bgMask7x7
