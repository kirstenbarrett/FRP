...
direct = '/smb/kb308_uol.le.ac.uk_root/staff/home/k/kb308/Research/FRP/FRPi'
os.chdir(direct)
filList = os.listdir('.')
...
while datIter < len(datList):
    ...
    for i, layer in enumerate(layersMOD02):
        ...
        if layer == 'EV_1KM_Emissive':
            ...
            B21scale,B22scale,B31scale,B32scale = radScales[B21index],radScales[B22index],radScales[B31index],radScales[B32index]
            B21offset,B22offset,B31offset,B32offset = radOffset[B21index],radOffset[B22index],radOffset[B31index],radOffset[B32index]
