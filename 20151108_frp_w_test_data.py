...
allArrays = {}
allArrays['BAND21'] = np.random.randint(400,size = (10,10))
allArrays['BAND22'] = np.random.randint(400,size = (10,10))
allArrays['BAND31'] = np.random.randint(400,size = (10,10))
allArrays['BAND32'] = np.random.randint(400,size = (10,10))
allArrays['BAND1x1k'] = np.random.randint(1000,size = (10,10)) 
allArrays['BAND2x1k'] = np.random.randint(1000,size = (10,10))
allArrays['landmask'] = np.random.randint(2,size = (10,10))
allArrays['SolarZenith']= np.random.randint(10000,size = (10,10))
allArrays['LAT']= np.random.rand(10,10)+np.random.randint(60,68,size = (10,10))
allArrays['LON']= np.random.rand(10,10)+np.random.randint(-148,-142,size = (10,10))
...
bgMask = np.ones((nRows,nCols),dtype=np.int)
...
#COMBINE TESTS
fireLoc = potFire*absValTest*deltaTMADfire*deltaTfire*B21fire*B31fire*B21rejFire

b21firesAllMask = b21mask*fireLoc
b21bgAllMask = b21meanFilt*fireLoc
